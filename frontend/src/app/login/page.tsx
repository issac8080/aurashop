...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-[80vh] flex items-center justify-center py-12 px-4"><div className="w-full max-w-md h-96 rounded-3xl bg-muted animate-pulse" /></div>}>
      <LoginPageContent />
    </Suspense>
  );
}
