"""
Add better product images using Unsplash API.
Generates category-appropriate images for each product.
"""
import json
...
def get_image_url_for_product(product: dict) -> str:
    """Generate a consistent image URL for a product."""
...
def main():
    ...
    print("=" * 60)
    print("Adding Better Product Images")
    print("=" * 60)
    ...
    # Update image URLs
    print("\nGenerating category-appropriate image URLs...")
    updated = 0
    ...
    print(f"\nSaving {len(products)} products with new images...")
    ...
    print("\nRestart backend or refresh browser to see images!")
    print("=" * 60)
